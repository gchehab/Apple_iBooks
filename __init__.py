...
class InterfacePluginAppleBooks(InterfaceActionBase):
    ...
    '''
    name                = 'Apple_iBooks'
    description         = 'Synchronize with Apple iBooks/Books libraries'
    supported_platforms = ['osx'] #'''windows', 'osx', 'linux']
    ...
    actual_plugin       = 'calibre_plugins.apple_ibooks.ui:InterfacePlugin'
    ...
    def config_widget(self):
        ...
        from calibre_plugins.apple_ibooks.config import ConfigWidget
        return ConfigWidget()
